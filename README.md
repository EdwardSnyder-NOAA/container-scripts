...
To switch compilers, ensure that the new compilers are pre-loaded either on the [host compilers](#using-host-compilers) or the [Intel sandbox](#using-intel-sandbox). Once they are loaded, run the following commands:
```
