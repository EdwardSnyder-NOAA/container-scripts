...
# Add comma to top_dir array and update dir conf file
top_dir_comma=$(IFS=,; echo "${top_dir[*]}")
sed -i "s|NEW_COMPILER_DIRS=\(.*\)|NEW_COMPILER_DIRS=${top_dir_comma[*]}|g" bind_directories.conf
